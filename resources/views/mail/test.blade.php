              ...
              >
                <tr>
									<td width="12%" class="logo" style="text-align: left;">
										<img src="{{ asset('images/logo-icon.png') }}" alt="Company Logo"/>
										{{-- <img src="{{ $message->embed(asset('images/logo-icon.png')) }}" /> --}}
                  </td>
                    ...
                    >
                      <tr>
                        ...
                        >
                          ...
                          <div class="heading-section">
                            <h3>Sent Datetime</h3>
                            <p class="subheading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2020-07-16 00:00:00</p>
                          </div>
                        </td>
                      </tr>
                    </table>
                  ...
                  <td width="50%" class="text-center" rowspan="3">
                    <ul class="social">
                      <li>
												<a class="javascript:;">
													<img
														src="images/000-twitter-logo.png"
                          	{{-- src="{{ $message->embed(asset('images/000-twitter-logo.png')) }}" --}}
														alt=""
														style="
															width: 24px;
															max-width: 600px;
                      ...
                      <li>
												<a class="javascript:;">
													<img
                          	src="images/000-facebook-logo.png"
                          	{{-- src="{{ $message->embed(asset('images/000-facebook-logo.png')) }}" --}}
														alt=""
														style="
															width: 24px;
															max-width: 600px;
                      ...
                      <li>
												<a class="javascript:;">
													<img
                          	src="images/000-instagram-logo.png"
                          	{{-- src="{{ $message->embed(asset('images/000-instagram-logo.png')) }}" --}}
														alt=""
														style="
															width: 24px;
															max-width: 600px;
                      ...
                      <li>
												<a class="javascript:;">
													<img
                          	src="images/000-linkedin-logo.png"
                          	{{-- src="{{ $message->embed(asset('images/000-linkedin-logo.png')) }}" --}}
														alt=""
														style="
															width: 24px;
															max-width: 600px;
                ...
                <tr>
                  <td width="100%" class="text-center">
                    <ul class="social">
                      <li>
                        <img
                          src="images/004-twitter-logo.png"
                          alt=""
                          style="
                            width: 24px;
                            max-width: 600px;
                      ...
                      <li>
                        <img
                          src="images/006-instagram-logo.png"
                          alt=""
                          style="
                            width: 24px;
                            max-width: 600px;
